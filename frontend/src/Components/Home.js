...
export default function Home() {
  return (
    <div className="container mt-4">
      <h1 className="text-light">Create a Note</h1>
      <h2 className="ms-3 mt-5 text-light">Select Testnet</h2>
      <div className="row mt-4">
        <div className="col-md-4 mb-4">
          <Link
            to="/create"
            state={{ from: "11155111" }}
            className="card bg-transparent shadow"
          >
            <img
            ...
            <div className="card-body">
              <h5 className="card-title text-light">ETH Sepolia</h5>
            </div>
          </Link>
        </div>
        <div className="col-md-4 mb-4">
          ...
          >
            ...
            />
            <div className="card-body">
              <h5 className="card-title text-light">Scroll Sepolia</h5>
            </div>
          </Link>
        </div>
        <div className="col-md-4 mb-4">
          ...
          >
            ...
            />
            <div className="card-body">
              <h5 className="card-title text-light">Arbitrium Sepolia</h5>
            </div>
          </Link>
        </div>
      </div>
